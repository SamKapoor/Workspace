...
//        Cursor cursor = db.query(TABLE_TBLR_RevenueType, null, null, null, null, null, null, null);
    ...
    public Cursor searchCustomer(String TIN, String ReceiptNumber, String BusinessNumber, String CustomerNumber) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(TABLE_TBLR_RevenueCustomer, null, KEY_TINNO + "=? or " + KEY_RECEIPTNO + "=? or " + KEY_BUSINESSLICNO + "=? or " + KEY_CUSTOMERNO + "=?", new String[]{TIN, ReceiptNumber, BusinessNumber, CustomerNumber}, null, null, null, "1");
        return cursor;
    }
